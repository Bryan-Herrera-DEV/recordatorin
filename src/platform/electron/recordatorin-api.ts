import type { Reminder, ReminderId } from '@/features/reminders/domain/reminder'
...
export type RecordatorinApi = {
  ...
  readonly onReminderNotificationClicked: (callback: (payload: ReminderTriggeredPayload) => void) => () => void
